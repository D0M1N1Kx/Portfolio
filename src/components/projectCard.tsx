...
export function ProjectCard({
  ...
  return (
    <>
      <div className="border-b-2 border-sky-700 w-86 h-fit m-1 bg-blue-600/15 rounded-lg mb-4 hover:border-b-4 hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer">
