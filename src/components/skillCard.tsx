...
export function SkillCard({ title, items }: SkillCardParameters) {
  return (
    <>
      <div className="border-2 border-sky-700 w-86 min-h-44 h-auto py-6 m-1 bg-blue-600/15 rounded-lg hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer">
